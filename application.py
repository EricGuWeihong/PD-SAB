...
# Create a login page
try:
    authenticator.login(max_login_attempts=10,fields={'Form name':'✨ 派得AI解决方案', 'Username':'用户名', 'Password':'密码',
                      'Login':'登陆'},clear_on_submit=True)
...
if st.session_state["authentication_status"]:
    ...
    with col1:
        st.write(f'欢迎 *{st.session_state["name"]}* 使用派得AI演示应用')
    with col2:
